...
export const RentalContractTemplate: React.FC<RentalContractTemplateProps> = ({
  ...
  return (
    <div
      id={id}
      className={`max-w-4xl mx-auto bg-white p-12 shadow-lg my-8 text-gray-900 font-serif text-base leading-relaxed print:shadow-none print:m-0 print:p-8 ${className}`}
    >
      {/* 1. Tiêu đề Quốc hiệu & Tiêu ngữ */}
      <div className="text-center mb-6">
        <h2 className="text-center font-bold tracking-wider text-base sm:text-lg">
        ...
        {/* Tên Hợp đồng */}
        <h1 className="text-center font-bold text-2xl mb-2 tracking-tight">
      ...
      <div className="space-y-2 mb-6">
        <p className="font-bold">I. BÊN CHO THUÊ (BÊN A):</p>
      ...
      {/* 4. Bên Thuê (Bên B) */}
      <div className="space-y-2 mb-6">
        <p className="font-bold">II. BÊN THUÊ (BÊN B):</p>
        <ul className="pl-6 space-y-1.5 list-disc">
          <li className="whitespace-pre-wrap">
      ...
      <div className="space-y-5">
        <p className="font-bold">III. NỘI DUNG VÀ CÁC ĐIỀU KHOẢN THỎA THUẬN:</p>
